...
public class AreasAdapter extends ElementsAdapter {
    ...
    AreasAdapter(List<Point> points, List<Angle> angles, List<Vector> vectors, List<Area> areas, Context context) {
        super(points, angles, vectors, new ListAreaRef(areas), context);
    }
